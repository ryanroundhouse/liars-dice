...
export class SplashComponent implements OnInit {
  ...
  constructor(private lobbyService: LobbyService, private nameGeneratorService: NameGeneratorService, private router: Router) { }
  ...
  onClickCreateGame(){
    this.lobbyService.createGame().subscribe(createGameResponse => {
      this.lobbyService.joinGame(createGameResponse.value, this.nameGeneratorService.generateName()).subscribe(next => {
